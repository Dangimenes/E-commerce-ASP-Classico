...
if (EMAIL.indexOf('@') == -1 || EMAIL.indexOf('.') == -1) {
   ...
   <h2 align="center"><font color="#FF6666">Cadastro de Usuário:</font></h2>
 
   <div class="formCadastro">
  
   <form name="FormCadastro" method="post" action="inserir_user.asp" onSubmit="return Verifica(this);">
 ...
 <br /><p>&nbsp;&nbsp;O preenchimento &eacute; <font color="#FF0000">obrigat&oacute;rio</font> somente onde tiver (*) aster&iacute;sco.</p>
